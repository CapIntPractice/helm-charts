...
| nameOverride | string | `""` |  |
| nodeSelector | object | `{}` |  |
| oAuth.enable | bool | `false` |  |
| oktaConfig.clientId | string | `"${clientId}"` |  |
| oktaConfig.clientSecret | string | `"${clientSecret}"` |  |
| oktaConfig.url | string | `"https://discounttire.okta.com/oauth2/v1/authorize"` |  |
